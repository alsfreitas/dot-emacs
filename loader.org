...
"
      ...
      (use-package google-translate
        ...
        :init (progn
                (bind-key "C-x t l" 'google-translate-query-translate-reverse)
                (bind-key "C-x t L" 'google-translate-query-translate)
                (bind-key "C-x t K" 'google-translate-at-point)
                (bind-key "C-x t k" 'google-translate-at-point-reverse))
