...
** Packages
   ...
   #+BEGIN_SRC emacs-lisp
       ...
       ; Adds a lot of powerful refactoring facilities to Cider
       ...
       (use-package golden-ratio
         :ensure t)
       ; It's hard to remember keyboard shortcuts. This package pops up help after a short delay. 
       ...
       (use-package olivetti
         :ensure t)
       ; Outline-based notes management and organizer. All contrib files are also installed
       (use-package org
